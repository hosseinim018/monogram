...
def send_video_note(chat_id: Union[int, str], message_thread_id: Optional[int] = None,
                    video_note: Union[InputFile, str], duration: Optional[int] = None,
                    length: Optional[int] = None, thumbnail: Optional[Union[InputFile, str]] = None,
