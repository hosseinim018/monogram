...
def edit_message(text: str, chat_id: Optional[int]= None, message_id: Optional[int] = None, message_thread_id: Optional[int] = None, inline_message_id: Optional[str] = None,
