...
def send_contact(chat_id: Union[int, str], phone_number: str, first_name: str, last_name: Optional[str] = None,
                 message_thread_id: Optional[int] = None, vcard: Optional[str] = None,
