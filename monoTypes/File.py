...
class File(BaseType):
    ...
    def __init__(self, file_id: str, file_unique_id: str, file_size: int = None, file_path: str = None, *args, **kwargs):
        """
    ...
    def download(self, download_path, file_name):
        ...
        if self.bot:
            self.bot.download_file(file_path=self.file_path, download_path=download_path, file_name=file_name)
